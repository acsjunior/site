...
{{% callout note %}}
[Acesse a publicação completa no **Blog Ciência com Dados**](https://cienciacomdados.com.br/blog/2019-12-11-exemplo-de-interoperabilidade-entre-python-e-r-usando-o-pacote-reticulate/).
{{% /callout %}}
