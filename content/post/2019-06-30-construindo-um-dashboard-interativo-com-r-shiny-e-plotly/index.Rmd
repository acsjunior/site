...
{{% callout note %}}
[Acesse a publicação completa no **Blog Ciência com Dados**](https://cienciacomdados.com.br/blog/2019-06-30-construindo-um-dashboard-interativo-com-r-shiny-e-plotly/).
{{% /callout %}}
