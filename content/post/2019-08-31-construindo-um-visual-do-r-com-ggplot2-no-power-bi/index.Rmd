...
{{% callout note %}}
[Acesse a publicação completa no **Blog Ciência com Dados**](https://cienciacomdados.com.br/blog/2019-08-31-construindo-um-visual-do-r-com-ggplot2-no-power-bi/).
{{% /callout %}}
