...
![](/courses/git-for-windows/img/git-commands-001.png)
...
![](/courses/git-for-windows/img/git-commands-002.png)
![](/courses/git-for-windows/img/git-commands-003.png)

<br>

Execute o comando `git init` para inicializar o repositório git:

![](/courses/git-for-windows/img/git-commands-004.png)
...
![](/courses/git-for-windows/img/git-commands-005.png)

<br>

Execute o comando `git status` para verificar o status do repositório:

![](/courses/git-for-windows/img/git-commands-006.png)
